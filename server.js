...
// server.use('/lib', serve('./lib'))
// server.use('/img', serve('./img'))
// server.use('/favicon.ico', serve('./favicon.ico'))
// server.use('/sw.js', serve('./sw.js'))
// server.use('/sw-push.js', serve('./sw-push.js'))
// server.use('/manifest.json', serve('./static/manifest.json'))
// server.use('/index.html', serve('./index.html')) // 保留客户端渲染入口
